...
rustler::rustler_export_nifs!(
    "erldpc",
    [
        ("encode_tc128_native", 1, encode_tc128),
        ("decode_tc128_native", 2, decode_tc128),
        ("encode_tc256_native", 1, encode_tc256),
        ("decode_tc256_native", 2, decode_tc256),
        ("encode_tc512_native", 1, encode_tc512),
        ("decode_tc512_native", 2, decode_tc512),
        ("encode_tm1280_native", 1, encode_tm1280),
        ("decode_tm1280_native", 2, decode_tm1280),
        ("encode_tm1536_native", 1, encode_tm1536),
        ("decode_tm1536_native", 2, decode_tm1536),
        ("encode_tm2048_native", 1, encode_tm2048),
        ("decode_tm2048_native", 2, decode_tm2048),
        ("encode_tm5120_native", 1, encode_tm5120),
        ("decode_tm5120_native", 2, decode_tm5120),
        ("encode_tm6144_native", 1, encode_tm6144),
        ("decode_tm6144_native", 2, decode_tm6144),
        ("encode_tm8192_native", 1, encode_tm8192),
        ("decode_tm8192_native", 2, decode_tm8192)
    ],
    None
);
